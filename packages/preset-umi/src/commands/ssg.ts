    ...
    async fn() {
      ...
      await viteBuild({
        ...
        build: {
          ssrManifest: true,
          rollupOptions: {
            input: resolve(cwd, './.mini-umi-ssr/index.html'),
            output: {
              dir: resolve(cwd, './.mini-umi-ssr/static')
            },
          }
        }
      })
      ...
      await viteBuild({
        ...
        build: {
          rollupOptions: {
            input: resolve(cwd, './.mini-umi-ssr/entry-server.js'),

          },
          outDir: resolve(cwd, './.mini-umi-ssr/server'),
        }
      })
      console.log();
      console.log();
